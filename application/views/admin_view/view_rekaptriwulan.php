            ...
            <div class="row mt-5">
                <div class="col">
                    ...
                    <?php foreach ($triwulan as $lhs) : ?>
                        <!-- button -->
                        <a class="btn bg-gradient-primary btn-sm" href="<?php echo base_url() ?>index.php/Admin/zip_rekap_triwulan/<?= $lhs['id'] ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-normal">
                                                    <a href="#!" data-bs-toggle="modal" data-bs-target="#triwulan<?= $lhs['id_triwulan'] ?>" class="fas fa-upload"></a>
                                                </span>
                                            </td>
                                            <td class="align-middle text-center">
                                                ...
                                                <span class="text-secondary text-xs font-weight-normal">
                                                    ...
                                                    <a href="<?php echo base_url() ?>index.php/Admin/download_xls_rekap_tri/<?= $lhs['id_triwulan'] ?>" class="fas fa-file-excel"></a>
                                                </span>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="<?php echo base_url('Admin/lap_RekapTriwulan'); ?>" enctype="multipart/form-data">
