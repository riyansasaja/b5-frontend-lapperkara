                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-normal">
                                                    ...
                                                    <a href="<?php echo base_url() ?>index.php/Pta_user/download_xls/<?= $lhs['id'] ?>">
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-normal">
                                                    <a href="<?php echo base_url() ?>index.php/Pta_user/zip_file/<?= $lhs['id'] ?>" class="fas fa-download"></a>
                                                </span>
            ...
            <div class="modal fade" id="validasiModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?php echo base_url('Pta_user/add_validasi'); ?>" enctype="multipart/form-data">
                                <?php foreach ($laporan as $lhs) : ?>
                                    <input type="text" id="id_laper" name="id_laper" value="<?php echo $lhs['id'] ?>" hidden>
                                <?php endforeach; ?>
