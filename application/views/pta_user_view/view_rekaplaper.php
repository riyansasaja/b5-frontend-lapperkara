                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" id="tahun">
                            <?php foreach ($years as $y) : ?>
                                ...
                                <li><a class="dropdown-item" href="<?php echo base_url(); ?>index.php/Pta_user/rekap_search_year/<?php echo $y['year'];  ?>" value="1"><?php echo $y['year']; ?></a></li>
                                        ...
                                        <?php foreach ($all as $one) : ?>
                                            <?php if (date('m', strtotime($one['periode'])) == '01') : ?>
                                                <div class="d-flex flex-column justifxy-content-center px-3">
                                                    <a href="<?php echo base_url() ?>index.php/Pta_user/zip_file_rekap/<?= $one['id'] ?>">
