                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" id="tahun">
                            <?php foreach ($years as $y) : ?>
                                ...
                                <li><a class="dropdown-item" href="<?php echo base_url(); ?>index.php/Pta_user/rekap_triwulan_year/<?php echo $y['periode_tahun'];  ?>" value="1"><?php echo $y['periode_tahun']; ?></a></li>
                                        ...
                                        <?php foreach ($all as $one) : ?>
                                            <?php if ($one['periode_triwulan'] == '03') : ?>
                                                <div class="d-flex flex-column justifxy-content-center px-3">
                                                    <a href="<?php echo base_url() ?>index.php/Pta_user/view_rekap_tri/<?= $one['id'] ?>">
